...
public class DressesController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // ============== Chic Racer  ==================//
        name1.setText(LoginController.chicRacer.getProductName());
        price1.setText(Double.toString(LoginController.chicRacer.getProductPrice()));

        // ============== Vintage Reverie ==================//

        name2.setText(LoginController.vintageReverie.getProductName());
        price2.setText(Double.toString(LoginController.vintageReverie.getProductPrice()));
    }
    ...
    public void addtoBag(ActionEvent event) throws IOException {
        ...
        if (sourceButton.equals(addtoBag1)) {
            LoginController.chicRacer.setProductStatus(true);
            LoginController.chicRacer.setProductQuantity(1);
            LoginController.cart.addItem(LoginController.myBagController.pane5);
        }

        else if (sourceButton == addtoBag2) {
            LoginController.vintageReverie.setProductStatus(true);
            LoginController.vintageReverie.setProductQuantity(1);
            LoginController.cart.addItem(LoginController.myBagController.pane6);
        }
